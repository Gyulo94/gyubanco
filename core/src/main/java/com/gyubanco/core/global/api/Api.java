package com.gyubanco.core.global.api;
...
import com.gyubanco.core.global.error.ErrorCodeInterface;
import com.gyubanco.core.global.message.ResponseMessageInterface;
...
public class Api<T> {
  ...
  private Api(int statusCode, String message, String timestamp, String path, String method, T body) {
    ...
    this.timestamp = Objects.requireNonNullElseGet(timestamp, Api::getCurrentTimestamp);
    this.path = Objects.requireNonNullElseGet(path, Api::getCurrentRequestUri);
    this.method = Objects.requireNonNullElseGet(method, Api::getCurrentMethod);
    this.body = body;
  }
